...
@Component({
        ...
        <div class="inner">
          ...
          <div class="badges">
            ...
            <!--
              ...
              code behind it - which for a portfolio piece is the wrong way
              round. Sits with the badges because it is the same kind of thing:
              a fact about this deployment rather than a place in it, so it is
              deliberately not one of the section tabs below.
            -->
            <a class="badge repo" [href]="repoUrl" target="_blank" rel="noreferrer"
               title="Read the source on GitHub" aria-label="Read the source on GitHub">
              <svg viewBox="0 0 16 16" width="15" height="15" aria-hidden="true">
                <path fill="currentColor" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47
                  ...
                  -1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87
  ...
  styles: `
    ...
    */
    ...
    /* A link, so it needs the affordances a div does not: a pointer, a visible
       hover, and a focus ring for anyone arriving by keyboard. */
    .repo {
      color: inherit;
...
export class App {
   ...
   *
   * It is the same string in every environment and it is already public, so
   * plumbing it through a config endpoint would buy nothing and add a way for
   * the header to render a dead link when that endpoint is the thing that is
   * down.
   */
